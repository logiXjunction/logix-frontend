...
import { User, ClipboardList, Trash2 } from 'lucide-react';
...
export default function DriverRegistrationModal() {
  ...
  const validateDriver = (d) => {
    ...
    else if (!/^\d{10}$/.test(d.phoneNumber))
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div className="relative bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
          <div className="flex items-center space-x-3 mb-1">
            ...
            <h2 className="text-xl font-bold text-white">Driver Registration</h2>
          </div>
        ...
        {/* Single Driver Form */}
        <form className="p-6 space-y-6" onSubmit={handleAddDriver}>
          ...
          {drivers.length > 0 && (
            <div className="mb-4">
              <h3 className="text-md font-semibold mb-2 flex items-center gap-2">
                <ClipboardList className="inline-block" /> Added Drivers
              </h3>
